...
<head>
  ...
  <title>Biblioteca Luz e Saber | Cadastrar livro</title>
...
<form action="php/cadastrar.php" method="POST">
  <div class="container">
    ...
    <input class="form-control" name="estante" id="estante" type="text">
    <br>
    
    
    <label for="prateleira">Prateleira <span class="lab">(Opcional)</span></label>
    <input class="form-control" name="prateleira" id="prateleira" type="text">
